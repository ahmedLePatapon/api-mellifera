...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var logger, app, config, documentFactory, port;
        var _a;
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    config = new swagger_1.DocumentBuilder()
                        ...
                        .setDescription('API REST de gestion apicole — Ruchers, Ruches, Inspections. ' +
                ...
                case 2:
                    _b.sent();
                    logger.log("\uD83D\uDC1D API Mellifera is running on: http://localhost:".concat(port));
                    logger.log("\uD83D\uDCDA Swagger UI available at: http://localhost:".concat(port, "/api"));
                    return [2 /*return*/];
            }
        });
    });
