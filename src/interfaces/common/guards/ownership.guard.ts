...
export function SetResourceType(type: ResourceType): ClassDecorator & MethodDecorator {
    return (target: Function | Object, _propertyKey?: string | symbol, _descriptor?: PropertyDescriptor): void => {
        Reflect.defineMetadata(RESOURCE_TYPE_KEY, type, (_descriptor && _descriptor.value) ?? target);
    };
}
